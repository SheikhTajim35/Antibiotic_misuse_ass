...
data2$Knowledge_level  <- as.factor(data2$Knowledge_level)



K_model <- polr(Knowledge_level ~  `Parent’s age (years)` +                        
                  `Parent’s sex`+                                
...
gtsave(T4_reg, "Tables/Table_4_UV_LogReg_Knowledge_level.docx")
